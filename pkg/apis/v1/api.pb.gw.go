...
func request_ResourceCatalog_UpdateShare_0(ctx context.Context, marshaler runtime.Marshaler, client ResourceCatalogClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq ResourceCatalogUpdateShareRequest
	var metadata runtime.ServerMetadata
...
func local_request_ResourceCatalog_UpdateShare_0(ctx context.Context, marshaler runtime.Marshaler, server ResourceCatalogServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq ResourceCatalogUpdateShareRequest
	var metadata runtime.ServerMetadata
...
func RegisterResourceCatalogHandlerServer(ctx context.Context, mux *runtime.ServeMux, server ResourceCatalogServer) error {
	...
	mux.Handle("PUT", pattern_ResourceCatalog_UpdateShare_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		var stream runtime.ServerTransportStream
		ctx = grpc.NewContextWithServerTransportStream(ctx, &stream)
		...
		resp, md, err := local_request_ResourceCatalog_UpdateShare_0(rctx, inboundMarshaler, server, req, pathParams)
		md.HeaderMD, md.TrailerMD = metadata.Join(md.HeaderMD, stream.Header()), metadata.Join(md.TrailerMD, stream.Trailer())
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
		...
		forward_ResourceCatalog_UpdateShare_0(ctx, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
func RegisterResourceCatalogHandlerClient(ctx context.Context, mux *runtime.ServeMux, client ResourceCatalogClient) error {
	...
	mux.Handle("PUT", pattern_ResourceCatalog_UpdateShare_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := request_ResourceCatalog_UpdateShare_0(rctx, inboundMarshaler, client, req, pathParams)
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
...
var (
	...
	pattern_ResourceCatalog_UpdateShare_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 1, 0, 4, 1, 5, 3, 1, 0, 4, 1, 5, 4}, []string{"v1", "catalogresource", "updateshare", "org_id", "uid"}, "", runtime.AssumeColonVerbOpt(true)))
)
...
var (
	...
	forward_ResourceCatalog_UpdateShare_0 = runtime.ForwardResponseMessage
)
