...
type Ownership struct {
	...
	Acls []*Ownership_AccessControl `protobuf:"bytes,2,rep,name=acls,proto3" json:"acls,omitempty"`
}
...
type Ownership_AccessConfig struct {
	...
	Permission Ownership_AccessType `protobuf:"varint,2,opt,name=permission,proto3,enum=Ownership_AccessType" json:"permission,omitempty"`
}
...
func (m *Ownership_AccessConfig) GetUserId() string {
	if m != nil {
		return m.UserId
	}
	return ""
...
func (m *Ownership_AccessConfig) GetPermission() Ownership_AccessType {
	if m != nil {
		return m.Permission
	}
	return Ownership_Invalid
...
type Ownership_AccessControl struct {
	...
	Groups []*Ownership_AccessConfig `protobuf:"bytes,1,rep,name=groups,proto3" json:"groups,omitempty"`
	...
	Collaborators []*Ownership_AccessConfig `protobuf:"bytes,2,rep,name=collaborators,proto3" json:"collaborators,omitempty"`
...
func (*Ownership_AccessControl) Descriptor() ([]byte, []int) {
	return fileDescriptor_b12f1cda86a0f641, []int{2, 2}
}
...
func (m *Ownership_AccessControl) GetGroups() []*Ownership_AccessConfig {
	if m != nil {
		return m.Groups
	}
	return nil
...
func (m *Ownership_AccessControl) GetCollaborators() []*Ownership_AccessConfig {
	if m != nil {
...
var fileDescriptor_b12f1cda86a0f641 = []byte{
	...
	,
}
...
func (m *Ownership_AccessConfig) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	_ = l
	if m.Permission != 0 {
		i = encodeVarintCommon(dAtA, i, uint64(m.Permission))
		i--
		dAtA[i] = 0x10
	}
	if len(m.UserId) > 0 {
...
func NewPopulatedOwnership(r randyCommon, easy bool) *Ownership {
	...
	if r.Intn(5) != 0 {
		v3 := r.Intn(5)
		this.Acls = make([]*Ownership_AccessControl, v3)
		for i := 0; i < v3; i++ {
			this.Acls[i] = NewPopulatedOwnership_AccessControl(r, easy)
		}
	}
	if !easy && r.Intn(10) != 0 {
	}
...
func NewPopulatedOwnership_AccessConfig(r randyCommon, easy bool) *Ownership_AccessConfig {
	...
	this.UserId = string(randStringCommon(r))
	this.Permission = Ownership_AccessType([]int32{0, 1, 2, 3}[r.Intn(4)])
	if !easy && r.Intn(10) != 0 {
	}
	return this
}
...
func NewPopulatedOwnership_AccessControl(r randyCommon, easy bool) *Ownership_AccessControl {
	...
	if r.Intn(5) != 0 {
		v4 := r.Intn(5)
		this.Groups = make([]*Ownership_AccessConfig, v4)
		for i := 0; i < v4; i++ {
	...
	if r.Intn(5) != 0 {
		v5 := r.Intn(5)
		this.Collaborators = make([]*Ownership_AccessConfig, v5)
		for i := 0; i < v5; i++ {
...
func randFieldCommon(dAtA []byte, r randyCommon, fieldNumber int, wire int) []byte {
	...
	case 0:
		...
		dAtA = encodeVarintPopulateCommon(dAtA, uint64(v7))
	case 1:
		dAtA = encodeVarintPopulateCommon(dAtA, uint64(key))
...
func (m *Ownership_AccessConfig) Size() (n int) {
	...
	if m.Permission != 0 {
		n += 1 + sovCommon(uint64(m.Permission))
	}
	return n
}
...
func (m *Ownership) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			...
			m.Acls = append(m.Acls, &Ownership_AccessControl{})
	...
	for iNdEx < l {
		...
		case 2:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.Permission |= Ownership_AccessType(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
